...
\begin{algorithm}
  ...
  \KwIn{$\mathcal{C}^{p_i}$, $\mathcal{C}^{p_j}$ and $\tilde{c}_{p_j}^{\ast}$}
  \KwOut{$\widetilde{\mathcal{U}}_{ij}\ and\  R^{\varpi}_+$}
  $\widetilde{\mathcal{U}}_{ij}=\mathcal{C}^{p_i}\cup \mathcal{C}^{p_j}$
  
  $\tilde{\eta}_{p_i}=\emptyset,\Omega_{p_j}=\emptyset$
  
  \ForEach{$Q'_{p_j}\in \mathcal{C}^{p_j}$}
  {
    \If{$Q'_{p_j}|\mathcal{F}^{p_j}=\tilde{c}_{p_j}^{\ast}|\mathcal{F}^{p_j}$}
    {
        add $Q'_{p_j}$ to $\Omega_{p_j}$
    }  
    \ForEach{$Q'_{p_i}\in \mathcal{C}^{p_i}$}
    {
        \If{$Q'_{p_i}|_{\mathcal{F}^{p_i}}\ is\ borded\ to\ Q'_{p_j}|_{\mathcal{F}^{p_j}}$}
        {
            add $Q'_{p_i}$ to $\tilde{\eta}_{p_i}$
            
            \If{$CheckTranB(Q'_{p_i}|_{\mathcal{B}^{p_i}},L_c(Q'_{p_i}|_{\mathcal{F}^{p_i}}), 
             Q'_{p_j}|_{\mathcal{B}^{p_j}},Q'_{p_j}|_{\mathcal{F}^{p_j}})\geqslant 0$}
            {
                $Q'_{p_j}\in \delta'(Q'_{p_i})$

                $W_p(Q'_{p_i},Q'_{p_j})=W_c(Q'_{p_i}|_{\mathcal{F}^{p_i}},Q'_{p_j}|_{\mathcal{F}^{p_j}})$

                $\tau(Q'_{p_i},Q'_{p_j}) = None$
            }
            \Else
            {
                \If{$L_c(Q'_{p_i}|_{\mathcal{F}^{p_i}})\in sym(\varphi_c^{p_j})$}
                {
                    $Q'_{p_j}\in \delta'(Q'_{p_i})$

                    $W_p(Q'_{p_i},Q'_{p_j})=W_c(Q'_{p_i}|_{\mathcal{F}^{p_i}},Q'_{p_j}|_{\mathcal{F}^{p_j}})$

                    $\tau(Q'_{p_i},Q'_{p_j})=L_c(Q'_{p_i}|_{\mathcal{F}^{p_i}})$
                }
            }
        }
    }
  }
  $R^{\varpi,p}_+=BidirectionDijkstra(\Omega_{p_j},\tilde{\eta}_{p_i})$
