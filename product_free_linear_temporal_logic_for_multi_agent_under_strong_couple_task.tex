  ...
  \ForEach{$\tilde{c}_{p_j}\in \mathcal{C}^{p_j}_n$}
  {
    ...
    \ForEach{$\tilde{c}_{p_i}\in \mathcal{C}^{p_i}_n$}
    {
        \If{$\tilde{c}_{p_i}|_{\mathcal{F}^{p_i}}\ is\ bordered\ to\ \tilde{c}_{p_j}|_{\mathcal{F}^{p_j}}$}
        {
            ...
            \If{$CheckTranB(\tilde{c}_{p_i}|_{\mathcal{B}^{p_i}},L^{p_i}(\tilde{c}_{p_i}|_{\mathcal{F}^{p_i}}),\tilde{c}_{p_j}|_{\mathcal{B}^{p_j}},\tilde{c}_{p_j}|_{\mathcal{F}^{p_j}})\geqslant 0$}
            {
...
\caption{(a) and (b) show the motion paths of an agent working on belts in simulation 3.}
\label{third}
\end{figure}
