...
After $p_{min}$ is elected, we design an attribute of agent named $state^{p_i}$ which turns into $locked$ when agent $p_i$ is providing collaboration, otherwise $state^{p_i}$ is $normal$. Meanwhile, due to the property of compact coupled task, all the request messages that have time overlapping can be replied by a group of heterogeneous agents. So towards each request message $Request^{p_i}$, if there is already a group of agents ${p_i}$ whose $state^{p_i}$ are $locked$, ${p_i}$ automatically become the collaborative agents and 
de dao shei qu reply hou, suo ding , zhi hou zai you req, shou xian pan duan you wu shi jian chong die,zhe li ke yi you yi ge shu xue wen ti,ru guo mei you chong die, ke yi pan duan shi li kai hai shi deng dai xia yi ge req shun bian xiang ying le. ji suan qi ta ji qi ren qu xiang ying de dai jia,he ling yi ge shen me dai jia bijiao yixia.
yu zhi qian de fangfa xiang bi,sheng qu le zheng shu gui hua, er shi jiao liu among agents, tui ju yi ge qu xie zuo,yin wei jie de yong yang de wen ti,zui hou de tui ju ren yi ding shi yi zhi de. yin wei dui yu compact coupled task, need to jiekai lock.confirm ling you ta yong
