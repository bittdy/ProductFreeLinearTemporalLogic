...
4. jiang shi jian fu za du(receding horizon, decomposition, zhen dui song ou he,yin ru wo men de gong zuo, ye ke shi yong yu song ou he ren wu ,women de gong xian)
...
A key challenge of applying LTL to the motion planning of multiagent systems is the computational complexity. In centralized method, all the agents need to product their agent model to synthesize the motion paths which satisfying all the task specifications[add ref], and the complexity exponential increases with the number of states. To fight with the massive amount of calculation, many methods are proposed. These methods can be classified into two aspects: (1) decompose the task specifications and decentralize the (2)receding the horizon of agents.

Our contribution can be summarized as proposal ..jin ou he ren wu you ming que de shun xv guan xi, ren wu yi dan fu za,huo zhe qian tao,wu fa qingsong de ding yi dong zuo de yi lai guan xi. zhi qian de suan fa kuang jia bu shi yong yu fu za de ren wu miao shu, dang wu fa ding yi dong zuo de  yi lai guan xi ,cong er wu fa sheng cheng chu shi lu jing shi, gai fang fa bu neng yong . ke yi bu yong ding yi da liang dong zuo yi lai guan xi er wan cheng jin ou he ren wu de product free, bing qie ke yi tong shi jie jue song ou he ren wu
